...
class Day21Test extends munit.FunSuite:
  ...
  test("Part 1 test0") {
    assertEquals(
      Day21.shortestPaths(Day21.arrows, Vec2(3, 1), Vec2(2, 2)).toSet,
      Set(Seq('<', 'v'), Seq('v', '<'))
    )
  }
  ...
  test("Part 2 test") {
    assertEquals(Day21.part2(getInput("day21/test.txt")), 154115708116294L)
  }

  test("Part 2") {
    assertEquals(Day21.part2(getInput("day21/input.txt")), 191139369248202L)
  }
